...
function $RouteProvider() {
   ...
   *      For easier access to the resolved dependencies from the templates, the `resolve` map will
 ...
 *
 * @knownIssue If `ngView` is contained in an asynchronously loaded templates (e.g. in another
 *             directive's templateUrl or in a templates loaded using `ngInclude`), then you need to
